...
exportgraphics(gca, 'figures/LeGresley_2508_eps=3.pdf')
hold off
...
set(l,'interpreter','latex');
l.FontSize = fontSize+7;
exportgraphics(gca, 'figures/LeGresley_2508_eps=2.pdf');
hold off
...
set(l,'interpreter','latex');
l.FontSize = fontSize+7;
exportgraphics(gca, 'figures/LeGresley_2508_eps=1.pdf');
hold off
